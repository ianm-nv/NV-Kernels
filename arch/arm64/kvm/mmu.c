			  ...
			  phys_addr_t pa, unsigned long size, bool writable)
{
	...
	/* Special pages cannot be mapped into a Realm */
	if (kvm_is_realm(kvm))
		return -EPERM;
			  ...
			  bool fault_is_perm)
{
	...
	/*
	 * For now protected addresses for Realms should be handled in
	 * private_memslot_fault(). Avoid mapping anything else into that
	 * address range until protected devices are supported.
	 */
	if (vcpu_is_rec(vcpu) &&
