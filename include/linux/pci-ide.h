 ...
 * SPDX-FileCopyrightText: Copyright (C) 2021 ARM Ltd, All Rights Reserved.
...
#define PCI_IDE_ENABLE_FLAGS_DEFAULT_STREAM	BIT(22)
...
int pcie_ide_program_ep_stream(struct pci_dev *dev,
			       u8 streamid,
			       unsigned int flags);
